    ...
    <div class="container">
        ...
        <div class="isi-surat">
            ...
            <table class="data-pemohon">
                ...
                <tr><td>Alamat KTP</td><td>:</td><td><?= esc($data_pemohon->alamat_ktp) ?></td></tr>
            </table>
            <p class="indent">Adalah benar penduduk yang saat ini berdomisili dan bertempat tinggal di wilayah Desa Kaliboja.</p>
