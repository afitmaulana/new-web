    ...
    <div class="container">
        ...
        <div class="isi-surat">
            ...
            <table class="data-pemohon">
                <tr><td width="150px">Nama</td><td>:</td><td><b><?= esc(strtoupper($data_pemohon->nama_pemohon)) ?></b></td></tr>
                <tr><td>NIK</td><td>:</td><td><?= esc($data_pemohon->nik) ?></td></tr>
                <tr><td>Alamat</td><td>:</td><td><?= esc($data_pemohon->alamat_pemohon) ?></td></tr>
            </table>
            <p class="indent">Berdasarkan pengamatan dan data yang ada, nama tersebut di atas adalah benar penduduk Desa Kaliboja dan memiliki usaha sebagai berikut:</p>
            <table class="data-pemohon">
                <tr><td width="150px">Nama Usaha</td><td>:</td><td><b><?= esc($data_pemohon->nama_usaha) ?></b></td></tr>
                <tr><td>Alamat Usaha</td><td>:</td><td><?= esc($data_pemohon->alamat_usaha) ?></td></tr>
            </table>
            <p class="penutup indent">Demikian Surat Keterangan Usaha ini dibuat untuk dipergunakan sebagaimana mestinya.</p>
        </div>
